...
// Function to show clear pending modal
function showClearPendingModal() {
    document.getElementById('clearPendingModal').style.display = 'block';
}

// Function to confirm clear pending invoices
function confirmClearPending() {
    ...
    updateSalesTable();
    updateDeliveryTable();
    alert('Pending invoices cleared successfully.');
    closeModal('clearPendingModal');
}

// Function to show clear sales modal
function showClearSalesModal() {
    document.getElementById('clearSalesModal').style.display = 'block';
}

// Function to confirm clear sales invoices
function confirmClearSales() {
    ...
    updateSalesTable();
    updateDeliveryTable();
    alert('Sales invoices cleared successfully.');
    closeModal('clearSalesModal');
}

// Function to show clear delivery modal
function showClearDeliveryModal() {
    document.getElementById('clearDeliveryModal').style.display = 'block';
}

// Function to confirm clear delivery invoices
function confirmClearDelivery() {
    ...
    updateSalesTable();
    updateDeliveryTable();
    alert('Delivery invoices cleared successfully.');
    closeModal('clearDeliveryModal');
}
...
// Function to confirm clear invoice history
