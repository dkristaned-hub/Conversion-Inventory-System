...
// Function to show clear logs modal
function showClearLogsModal() {
    document.getElementById('clearLogsModal').style.display = 'block';
}

// Function to confirm clear logs
...
// Function to show clear stock reports modal
function showClearModal() {
    document.getElementById('clearModal').style.display = 'block';
}

// Function to confirm clear stock reports
function confirmClearStockReports() {
    localStorage.removeItem('stockReports');
    updateStorageMonitoringTable();
