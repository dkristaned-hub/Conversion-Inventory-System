...
// Function to show clear employee log modal
function showClearEmployeeLogModal() {
    document.getElementById('clearEmployeeLogModal').style.display = 'block';
}

// Function to show clear employee shifts modal
function showClearEmployeeShiftsModal() {
    document.getElementById('clearEmployeeShiftsModal').style.display = 'block';
}

// Function to show clear present attendance modal
function showClearPresentAttendanceModal() {
    document.getElementById('clearPresentAttendanceModal').style.display = 'block';
}

// Function to show clear all accounts modal
function showClearAllAccountsModal() {
    document.getElementById('clearAllAccountsModal').style.display = 'block';
}
...
// Function to confirm clear employee log
function confirmClearEmployeeLog() {
    localStorage.removeItem('employeeLog');
    updateEmployeeLogTable();
    updateEmployeeStats();
    closeModal('clearEmployeeLogModal');
}

// Function to confirm clear employee shifts
function confirmClearEmployeeShifts() {
    localStorage.removeItem('employeeShifts');
    updateEmployeeShiftsTable();
    closeModal('clearEmployeeShiftsModal');
}

// Function to confirm clear present attendance
function confirmClearPresentAttendance() {
    localStorage.removeItem('attendance');
    updateAttendanceTable();
    updateEmployeeStats();
    closeModal('clearPresentAttendanceModal');
}
