...
function openStockReportForm() {
    ...
    fieldsDiv.innerHTML = `
        ...
        <select id="report-status" class="conversion-input" onkeydown="if(event.key==='Enter') submitStockReport()">
...
function clearLogs() {
  ...
  }, 'Verify Admin Password to Clear All Logs');
}
...
// Filter function for Usage Trends
function filterUsageTrends() {
    const searchValue = document.getElementById('usage-trends-date-search').value;
    const table = document.querySelector('#usage-trends');
...
// Clear filter for Usage Trends
function clearUsageTrendsFilter() {
    document.getElementById('usage-trends-date-search').value = '';
    filterUsageTrends();
}

// Filter function for Storage Monitoring
function filterStorageMonitoring() {
    const searchValue = document.getElementById('storage-monitoring-date-search').value;
    const table = document.querySelector('#storage-monitoring');
    const rows = table.getElementsByTagName('tr');
...
// Clear filter for Storage Monitoring
function clearStorageMonitoringFilter() {
    document.getElementById('storage-monitoring-date-search').value = '';
    filterStorageMonitoring();
}
